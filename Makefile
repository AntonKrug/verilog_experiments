...
build/icezero.blif: top.v pll.v blinky.v vga_sync.v reset.v clock_divide.v
...
build/icezero.asc: build/icezero.blif icezero.pcf
	...
	nextpnr-ice40 --hx8k --package tq144:4k --json build/icezero.json --pcf icezero.pcf --asc build/icezero.asc --freq ${freq}
